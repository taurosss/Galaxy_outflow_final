...
##        legend_button.on_clicked(self.show_legend)
        ...
        print(Nx,Ny)
        self.doPlot(np.round(200), np.round(200))
...
#    yrange=None
    ...
    cube1 = Readcube(fitsfile1, beam = False)    
#    cube1.cube /= 0.004273#np.nanmax(cube1.cube)
    cube2 = Readcube(fitsfile2, beam = False) 
